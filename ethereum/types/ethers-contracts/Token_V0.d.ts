...
interface Token_V0Interface extends Interface {
  functions: {
...
export class Token_V0 extends Contract {
  connect(signerOrProvider: Signer | Provider | string): Token_V0;
  attach(addressOrName: string): Token_V0;
  deployed(): Promise<Token_V0>;

  on(event: EventFilter | string, listener: Listener): Token_V0;
  once(event: EventFilter | string, listener: Listener): Token_V0;
  addListener(eventName: EventFilter | string, listener: Listener): Token_V0;
  removeAllListeners(eventName: EventFilter | string): Token_V0;
  removeListener(eventName: any, listener: Listener): Token_V0;

  interface: Token_V0Interface;
