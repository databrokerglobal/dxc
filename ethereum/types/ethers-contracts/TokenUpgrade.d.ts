...
interface TokenUpgradeInterface extends Interface {
  functions: {
    ...
    burn: TypedFunctionDescription<{encode([value]: [BigNumberish]): string}>;
...
export class TokenUpgrade extends Contract {
  connect(signerOrProvider: Signer | Provider | string): TokenUpgrade;
  attach(addressOrName: string): TokenUpgrade;
  deployed(): Promise<TokenUpgrade>;

  on(event: EventFilter | string, listener: Listener): TokenUpgrade;
  once(event: EventFilter | string, listener: Listener): TokenUpgrade;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): TokenUpgrade;
  removeAllListeners(eventName: EventFilter | string): TokenUpgrade;
  removeListener(eventName: any, listener: Listener): TokenUpgrade;
