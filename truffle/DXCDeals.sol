...
// File: contracts/dxc/DXCTokens.sol
...
// File: contracts/dxc/DXCDeals.sol
...
contract DXCDeals {
  ...
  function initialize(address dxcTokensAddress, address token) public {
    require(!initialized);
    dxcTokens = DXCTokens(dxcTokensAddress);
    dxcTokens.initialize(token);
    initialized = true;
  }
