...
contract DTXStaking is ERC20, Ownable {
   ...
   /**
    * @notice The starting period of each "stake".
    */
 ...
 /**
    ...
    * And the time they stake over a period of 30 days
     */
    function monthlyReward() view public returns (uint256) {
        address(this).balance;
    }

   /**
    * @notice A simple method that calculates the rewards for each stakeholder. This method will be called at the 
    * beginning of each month. Each stakeholder will receive stakes based on his/her proportion compared to the total staked amount
    * But also based on the length that a trader kept his token in the staking program over that month. 
    * @param _stakeholder The stakeholder to calculate rewards for.
    */
   function calculateReward(address _stakeholder, uint256 currentTime)
       public
       view
       returns(uint256)
   {
       return monthlyReward() * (stakes[_stakeholder] / totalStakes()) * (time[_time]/currentTime) ;
   }
