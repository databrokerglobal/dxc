...
// 2020-09-17 15:53:54.673024104 +0200 CEST m=+0.372089206
        ...
        "/datasource/{did}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "New header API key name. Keep empty to keep existing header API key name.",
                        "name": "newHeaderAPIKeyName",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "New header API key value. Keep empty to keep existing header API key value.",
